    ...
    <footer className="bg-greek-darkBlue text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Ποδήλατο Τεχνικός</h3>
          ...
          <div>
            ...
            <address className="not-italic">
              ...
              <p>Αθήνα, 12345</p>
              <p>Τηλέφωνο: <a href="tel:+302101234567" className="hover:text-greek-gold transition-colors">210 123 4567</a></p>
              <p>Email: <a href="mailto:info@podilatotexnikos.gr" className="hover:text-greek-gold transition-colors">info@podilatotexnikos.gr</a></p>
            </address>
          </div>
        </div>
        
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p>&copy; {new Date().getFullYear()} Ποδήλατο Τεχνικός. Με επιφύλαξη παντός δικαιώματος.</p>
        </div>
      </div>
    </footer>
  );
